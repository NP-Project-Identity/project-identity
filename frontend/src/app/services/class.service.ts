...
export class ClassService {
  ...
  private class: any[] = [
    ["PROGI", [
      {
        title: "Announcement", type: "folder", content: [
          {title: "Welcome to PROG 1", desc: "Welcome back to the School of ICT and hope that you had a good break.", type: "text"}
        ]
      },
      {
        title: "Week 1", type: "folder", content: [
          {title: "Week 1 ", desc: "Welcome back to the School of ICT and hope that you had a good break.", type: "text"},
          {title: "resource", desc: "File need to week 1 lesson", type: "folder"}
        ]
      },
