  ...
  private db = [
    ...
    },
    {
      ...
      quiz: [
        {
          type: 'mcq',
          question: 'What ICT stand for?',
          option: [
            'Information and Calling Technology',
            'Information and Communications Technology',
            'Infamous Communications Technology',
            'Information and Communications teaching',
          ],
          answer: 1,
        },
        {
          type: 'mcq',
          question: 'What does PROGI stand for?',
          option: ['Programming 1', 'Pro 1', 'Progamme 1', 'Python 1.0'],
          answer: 0,
        },
      ],
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          option: ['JavaScript', 'HTML', 'C++', 'Python'],
          answer: 1,
        },
      ],
    },
