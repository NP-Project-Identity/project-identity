...
export class UserService {
  ...
  private userDB = [
    ...
    },
    {
      //password is abcde
      id: 's101123451d',
      email: 's10112345@connect.np.edu.sg',
      password: 'ab56b4d92b40713acc5af89985d4b786',
      name: 'Alan Tan',
      coin: 0,
      achievement: {
        medal: [
          {id: 'dailyLogin', rank: 1},
          {id: 'comment', rank: 1},
          {id: 'feeder', rank: 1},
          {id: 'poster', rank: 1},
        ],
        trophy: ['Poster 2021', 'Comment 2021', 'Helper 2021'],
      },
      resource: {
        profile: 'default.png',
        bg: 's10198161d.jpg',
    ...
    },
    {
      ...
      achievement: {
        ...
        trophy: ['Poster 2021', 'Comment 2021'],
      },
      resource: {
        profile: 'default.png',
        bg: 'default.jpg',
  ...
  async login(email: string, pass: string) {
    await this.storage.create();
    const emails = this.userDB.find(el => el.email === email.toLowerCase());
